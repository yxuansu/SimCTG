...
if __name__ == '__main__':
    ...
    if eos_token == 'endoftext':
        eos_token == '<|endoftext|>'
        print (eos_token)
    data = Data(model_name, args.train_path, args.dev_path, args.test_path, args.min_len, args.max_len, 
        eos_token, args.pad_token)
    print ('Data loaded.')
    ...
    model = SimCTGDialogue(model_name, data.eos_token, args.pad_token)
    if cuda_available:
