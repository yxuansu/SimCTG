...
### News:
* [2022/09/06] :fire: We have added support for the newly released OPT models ([OPT: Open Pre-trained Transformer Language Models](https://arxiv.org/abs/2205.01068)) by Meta. To see how to apply contrastive search on OPT models, check it [here]!
