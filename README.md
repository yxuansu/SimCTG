...
:star: **[Documentation]** We provide detailed documentation of the **source code** of the package and **detailed instructions** on how to use the it, please refer to [[here]](https://github.com/yxuansu/SimCTG/tree/main/simctg).
