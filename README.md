...
We have encapsulated our work as an easy-to-use library (i.e., package). In the following, we provide huggingface-style tutorials on how to use SimCTG and contrastive search with just a few lines of code! For more detailed descriptions on how to use the package, please refer to [[here]]().
