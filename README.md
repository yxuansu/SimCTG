...
### News:
* [2022/09/06] :fire: We have added support for the newly released OPT models (see the [paper](https://arxiv.org/abs/2205.01068) and [models](https://huggingface.co/docs/transformers/model_doc/opt)) by Meta. To see how to apply contrastive search on OPT models, check it [here]!
